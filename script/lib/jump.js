...
const jumper = () => {
  ...
  function location() {
    return scrollThis.scrollY || scrollThis.pageYOffset || scrollThis.scrollTop;
  }
  ...
  function done() {
    ...
    scrollThis.scrollTo(0, start + distance);
  ...
  function jump(target, options = {}) {
    ...
    scrollThis = options.scrollThis || window;

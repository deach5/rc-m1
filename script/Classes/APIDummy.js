...
//
APIDummy.prototype.LMSInitialize = function (str) {
	return true;
}
APIDummy.prototype.LMSCommit = function (str) {
	return true;
}
APIDummy.prototype.LMSFinish = function (str) {
	return true;
}
APIDummy.prototype.LMSGetLastError = function () {
	return 0
}
APIDummy.prototype.LMSGetErrorString = function (error) {
	return;
}
APIDummy.prototype.LMSGetDiagnostic = function (error) {
	return;
}
